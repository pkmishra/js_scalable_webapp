/*
 * Namespace: ml.core.plugins.utils
...
define([
	...
	// Assign to ml.core.plugins.utils
	// for backward-compatibility in browser environment
	mlCorePlugins.utils = function (sandbox) {
		...
		// Note: is is an alias for ml.base.object.has
		...
		// Note: is is an alias for ml.base.type.is
		...
		function setTimeout(callback, delay) {
			...
			return window.setTimeout(function () {
				try {
					...
					log('ERROR: failure in setTimeout for callback ' + String(callback) + '.');
				}
			}, delay);
		}
		...
		// Note: trim is an alias for ml.base.string.trim
		...
		// Note: log is an alias for ml.base.log.print
