...
define([
	...
	// Assign to ml.core.plugins.dom
	// for backward-compatibility in browser environment$
	mlCorePlugins.dom = function (sandbox) {
		...
		var getId = sandbox.getId,
			...
			// A custom factory can be configured by setting the property mlFactory.
			// Defaults to ml.base.dom.factory.
		...
		function element(tag, attributes) {
			...
			//
			// A custom DOM factory can be configured using the property mlFactory
			// with <ml.core.application.setOptions(options)>.
			//
			// Parameters:
