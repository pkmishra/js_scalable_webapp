/*
 * Namespace: ml.core.plugins.events
...
define([
	"./ml.base.array",
	"./ml.core.plugins",
	"./ml.core.events.publisher",
	"./ml.core.events.Subscriber"
], function (
	array,
	mlCorePlugins,
	publisher,
	...
	// Assign to ml.core.plugins.events
	// for backward-compatibility in browser environment
	mlCorePlugins.events = function (sandbox) {
		...
		function subscribe(filter, callback) {
			...
			//
			// A new instance of Event Subscriber (ml.core.events.Subscriber) is
			// created and added to the Event publisher (ml.core.events.publisher).
			//
			// Parameters:
		...
		// Note: publish is an alias for ml.core.events.publisher.publish
